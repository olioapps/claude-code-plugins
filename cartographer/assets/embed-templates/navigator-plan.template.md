...
Source: cartographer/commands/navigator/plan.md
...
- If >30 days old, warn: "⚠️ Atlas may be outdated. Consider `/calibrate`"
...
2. Run `/spec-build specs/{filename}.md` to execute
...
| Atlas stale | Warn, continue | Suggest /calibrate |
