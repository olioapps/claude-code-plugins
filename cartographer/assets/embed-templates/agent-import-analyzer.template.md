...
Source: cartographer/agents/import-analyzer.md
...
This agent is invoked **optionally** during `/chart --deep` or when the user requests import analysis. It supplements (not replaces) the surveyor's directory-based domain detection.
