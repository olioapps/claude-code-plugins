<!--
Embedded Agent Definition: atlas-validator
Source: cartographer/agents/review/atlas-validator.md
...
**Required sections:**
- [ ] Domain Router (table with keywords, domains, paths)
- [ ] Pattern Router (table with patterns and guides)
- [ ] File Location Conventions (table with types and patterns)
- [ ] Key Technologies (list or table)
- [ ] Validation Commands (code block)
