...
3. Reference the `commit-best-practices` skill for formatting guidelines
4. Generate an optimal commit message
5. Create the commit using git commands
...
- [ ] Ready to execute git commit command

## Execution

When ready, execute the commit using the heredoc format shown above. Return the commit SHA and a brief confirmation to the user.
